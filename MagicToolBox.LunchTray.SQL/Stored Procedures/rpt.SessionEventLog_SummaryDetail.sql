...
Description: This proc will give a summary of the week number provided in @WeekOfYear
    Example: Declare @ThisWeekNo Int = DatePart(wk, DateAdd(wk,  0, GetDate())) -- Get THIS Weeks Data (  0 )
                    ,@LastWeekNo Int = DatePart(wk, DateAdd(wk, -1, GetDate())) -- Get LAST Weeks Data (  0 )
             Exec rpt.SessionEventLog_SummaryDetail @ThisWeekNo
             Exec rpt.SessionEventLog_SummaryDetail @LastWeekNo
--------------------------------------------------------------------------------
